...
## Done
- [x] **Parse the MyHeritage export** — 614 individuals; 15 duplicates merged on evidence,
      58 shared names left apart, 14 components identified.
- [x] **Save the 133 photographs** before the MyHeritage links expire 16 September 2026.
...
- [ ] **Antenati** — 403 everywhere on 10 Sep 2026, including its home page. Known to rate-limit to a
      blanket 403 and recover. Retry; the endpoints in `antenati-method` are correct.
- [ ] **FamilySearch** — site-wide Error 15 from the in-app browser, naming the proxy IP. The
      full-text search in `familysearch-fulltext-method` is the single best tool for the Sicilian and
      Calabrian registers and could not be used at all.
